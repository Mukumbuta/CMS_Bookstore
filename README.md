...
**[CMS_Bookstore]** is an MVP version of the Bookstore website that allows a user to:  Display a list of books; Add a book; and Remove a selected book. Built using React and Redux.
...
- [ ] **[Real time reading history update]**
